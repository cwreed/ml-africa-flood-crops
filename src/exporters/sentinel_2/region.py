...
class RegionalSentinel2Exporter(BaseSentinel2Exporter):
    ...
    def export_for_region(
        ...
        start_date = inference_date - timedelta(days = days_per_timestep * n_timesteps)
